...
{
    public partial class MoniTechContext : DbContext
    {
        public MoniTechContext()
        {
        }

        public MoniTechContext(DbContextOptions<MoniTechContext> options)
            : base(options)
        {
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Usuarios>(entity =>
            {
                ...
                entity.HasIndex(e => e.Email)
                    .HasName("UQ__USUARIOS__161CF7244240D19D")
                    .IsUnique();
                ...
                entity.HasOne(d => d.IdTipoUsuarioNavigation)
                    ...
                    .HasConstraintName("FK__USUARIOS__ID_TIP__70DDC3D8");
            });
        }
    }
}
